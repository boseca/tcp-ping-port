...
exports.tcpPingPort = (host, port = 80, options = null, resolver = null) => {
    ...
    if (!isString(host)) { console.warn(`Host '${host}' is not string`); return Promise.resolve(result) }
    if (!isNumber(port)) { console.warn(`Port '${port}' is not number`); return Promise.resolve(result) }
    // #endregion
